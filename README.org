...
[[https://github.com/japhir/paleoinsolation/actions][https://github.com/japhir/paleoinsolation/actions/workflows/ci.yml/badge.svg]]
...
If your project uses [[https://github.com/pjbartlein/PaleoCalAdjust][PaleoCalAdjust]], see the directory [[file:PaleoCalAdjust/]] for a drop-in replacement file and [[file:PaleoCalAdjust/README.org]] for instructions.
...
- [[file:PaleoCalAdjust/KZ_orbpar_subs.f90]] drop-in replacement for subroutine [[https://github.com/pjbartlein/PaleoCalAdjust/blob/master/f90/modules/GISS_orbpar_subs.f90][GISS_orbpar_subs.f90]] in [[https://github.com/pjbartlein/PaleoCalAdjust][PaleoCalAdjust]]. See [[file:PaleoCalAdjust/README.org]] for instructions.
- [[file:CESM/]] drop-in replacement for the ~shr_orb_params~ subroutine in the [[https://github.com/ESCOMP/CDEPS/blob/main/share/shr_orb_mod.F90][shr_orb_mod]] module in [[https://github.com/ESCOMP/CDEPS/tree/main][CDEPS]]. See [[file:CESM/README.org]] for instructions.
...
#+begin_src sh
   ...
   make test       # run fortran code tests
   make insolation # run fortran code to calc insolation
                   # for a time interval, uses input file
#+end_src

The default target is ~make insolation~, which will compile the Fortran code and calculate insolation while re-using the existing precession-tilt files.
...
Crucifix, M. (2023). Palinsol: A R package to compute incoming Solar Radiation (insolation) for palaeoclimate studies (v1.0) [Software]. /Zenodo/. doi: [[https://doi.org/10.5281/zenodo.14893715][10.5281/zenodo.14893715]]
